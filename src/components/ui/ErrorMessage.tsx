    ...
    <div className="rounded-[32px] bg-rose-500/5 border border-rose-500/10 p-10 animate-fade-in text-center max-w-2xl mx-auto shadow-2xl">
      ...
      <div className="flex items-center justify-center gap-3 flex-wrap">
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="px-8 py-4 text-xs font-black uppercase tracking-[0.2em] text-slate-400 hover:text-white border border-slate-500/30 hover:border-slate-400 rounded-2xl transition-all active:scale-95"
          >
            Dismiss
          </button>
        )}
